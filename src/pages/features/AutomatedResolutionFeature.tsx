...
const AutomatedResolutionFeature = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Résolution Automatique des Problèmes Clients | IA Diagnostic | Celsai</title>
        <meta name="description" content="Résolvez rapidement les problèmes techniques de vos clients grâce à notre diagnostic IA et nos guides étape par étape. Réduction des tickets jusqu'à 60-80% sans intervention humaine." />
        <meta name="keywords" content="résolution automatique, diagnostic IA, self-service, guides interactifs, réduction tickets support, Celsai" />
        <link rel="canonical" href="https://www.celsai.com/features/automated-resolution" />
