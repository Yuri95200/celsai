...
const KnowledgeBaseFeature = () => {
  return (
    <>
      <Helmet>
        <title>Base de Connaissances IA Dynamique | Assistance Intelligente | Celsai</title>
        <meta name="description" content="Notre base de connaissances IA centralise toutes vos informations pour des réponses précises et cohérentes. Synchronisation automatique avec vos documents et apprentissage continu." />
        <meta name="keywords" content="base de connaissances IA, gestion des connaissances, documentation automatisée, apprentissage machine, recherche sémantique, Celsai" />
        <link rel="canonical" href="https://www.celsai.com/features/knowledge-base" />
        ...
        <meta property="og:image" content="/lovable-uploads/055c1e16-f0f4-4267-a6a5-69c10c20a6ee.png" />
        <script type="application/ld+json">{`
          {
            ...
            "image": "/lovable-uploads/055c1e16-f0f4-4267-a6a5-69c10c20a6ee.png",
            "brand": {
              "@type": "Brand",
              "name": "Celsai"
            },
