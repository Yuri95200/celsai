...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <Helmet>
        <title>Politique de Confidentialité | Protection des Données | Celsai</title>
        <meta name="description" content="Notre politique de confidentialité détaille comment nous collectons, utilisons et protégeons vos données personnelles conformément au RGPD et autres réglementations." />
        <meta name="keywords" content="confidentialité données, RGPD IA, protection informations, sécurité données client, politique privée, Celsai" />
        <link rel="canonical" href="https://www.celsai.com/privacy" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Politique de Confidentialité | Protection des Données | Celsai" />
        <meta property="og:description" content="Notre politique de confidentialité détaille comment nous collectons, utilisons et protégeons vos données personnelles." />
        <meta property="og:url" content="https://www.celsai.com/privacy" />
