...
const TermsOfService = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <Helmet>
        <title>Conditions d'Utilisation | Celsai Solutions d'IA</title>
        <meta name="description" content="Consultez nos conditions d'utilisation détaillées pour comprendre les termes qui régissent l'utilisation de la plateforme Celsai et nos services d'IA pour le service client." />
        <meta name="keywords" content="conditions utilisation Celsai, termes service IA, obligations légales, droits utilisateur, politique service, Celsai" />
        <link rel="canonical" href="https://www.celsai.com/terms" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Conditions d'Utilisation | Celsai Solutions d'IA" />
        <meta property="og:description" content="Consultez nos conditions d'utilisation détaillées pour comprendre les termes qui régissent l'utilisation de la plateforme Celsai." />
        <meta property="og:url" content="https://www.celsai.com/terms" />
