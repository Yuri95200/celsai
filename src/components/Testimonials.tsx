  ...
  return <section id="testimonials" className="py-20 bg-gray-50">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {testimonials.map(testimonial => <div key={testimonial.id} className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col">
              <div className="mb-4">
                {testimonial.icon}
              </div>
