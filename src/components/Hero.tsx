...
import { Motion, ArrowRight } from "lucide-react";
      ...
      <Container>
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
            <div className="space-y-6 max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button className="bg-celsai-500 hover:bg-celsai-600 text-white text-lg py-6 px-8">
                  Commencer l'essai gratuit
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <Button variant="outline" className="border-gray-200 hover:border-celsai-400 hover:bg-celsai-50 text-lg py-6 px-8">
                  Voir la démo
                </Button>
              </div>
              <div className="pt-6 flex items-center space-x-6">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((index) => (
                    <div key={index} className={`w-10 h-10 rounded-full border-2 border-white bg-celsai-${100 + index * 100} flex items-center justify-center shadow-sm`}>
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="absolute -right-10 -bottom-10 w-64 h-64 bg-celsai-100 rounded-full opacity-50 filter blur-3xl"></div>
            <div className="absolute -left-10 -top-10 w-64 h-64 bg-celsai-200 rounded-full opacity-50 filter blur-3xl"></div>
              ...
              <div className="bg-white rounded-lg overflow-hidden border border-gray-100">
                ...
                <div className="p-4 h-80 overflow-hidden flex flex-col">
                  <div className="flex mb-4">
                    <div className="bg-celsai-100 text-celsai-800 rounded-2xl rounded-tl-none py-2 px-4 max-w-[80%]">
                  ...
                  <div className="flex mb-4">
                    <div className="bg-celsai-100 text-celsai-800 rounded-2xl rounded-tl-none py-2 px-4 max-w-[80%]">
                      <div className="h-4 w-16 bg-celsai-200 rounded-full animate-pulse"></div>
                    </div>
                  </div>
                </div>
                <div className="bg-white border-t border-gray-100 p-4">
                  <div className="flex items-center">
                    <input
                      ...
                      className="w-full px-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-celsai-500 focus:border-transparent"
                    />
                    <button className="ml-2 bg-celsai-500 text-white p-2 rounded-full">
