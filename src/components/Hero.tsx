...
const Hero = () => {
  return (
    <>
      <Helmet>
        <meta name="description" content="Transformez votre service client avec Celsai, la solution d'IA qui automatise jusqu'à 70% de vos interactions tout en améliorant la satisfaction client. Essai gratuit disponible." />
        <meta name="keywords" content="IA service client, chatbot intelligent, support automatisé, satisfaction client, réduction coûts, Celsai" />
        <meta property="og:title" content="Celsai - L'intelligence artificielle au service de votre support client" />
        <meta property="og:description" content="Solution d'IA qui automatise jusqu'à 70% de vos interactions clients tout en améliorant la satisfaction. Essai gratuit disponible." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Celsai - IA pour Service Client" />
        <meta name="twitter:description" content="Automatisez jusqu'à 70% de vos interactions clients avec notre IA. Essai gratuit disponible." />
      </Helmet>
