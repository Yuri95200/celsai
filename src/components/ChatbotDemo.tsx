  ...
  const chatScenarios: ChatScenario[] = [
    {
      ...
      botResponses: [
        "Pour effectuer un remboursement, veuillez me communiquer votre numéro de commande afin que je puisse vérifier son éligibilité.",
        "Merci. J'ai retrouvé votre commande #FR2345678. D'après notre politique, elle est éligible au remboursement jusqu'au 30 juin. Souhaitez-vous un remboursement sur votre moyen de paiement initial ou un avoir ?",
        "Parfait. J'ai initié la procédure de remboursement sur votre carte bancaire. Vous recevrez une confirmation par email dans les prochaines minutes et le montant sera crédité sous 3 à 5 jours ouvrés. Puis-je vous aider avec autre chose ?"
      ]
    },
    {
      keyword: "facturation",
      ...
      botResponses: [
        "Concernant votre facturation, pourriez-vous préciser s'il s'agit d'une facture spécifique ou de votre abonnement en général ?",
        "Je vois. Pour votre abonnement Premium, vous êtes actuellement facturé 49€/mois avec prélèvement le 15 de chaque mois. Votre dernière facture a été émise le 15 mai. Souhaitez-vous modifier vos coordonnées bancaires ou votre formule d'abonnement ?",
        "Je comprends. Je viens de vous envoyer par email un lien sécurisé pour mettre à jour vos coordonnées bancaires. Ce lien est valable 24h. La modification sera prise en compte pour votre prochain prélèvement."
      ]
    },
    {
      keyword: "livraison",
      ...
      botResponses: [
        "Pour vous renseigner sur l'état de votre livraison, j'aurais besoin de votre numéro de commande ou de l'email associé à votre compte.",
        "Merci pour ces informations. Votre commande #FR7890123 est actuellement en transit. Selon les informations du transporteur, elle sera livrée demain entre 9h et 12h à l'adresse indiquée. Souhaitez-vous recevoir les détails de suivi par SMS ?",
        "Parfait, je viens de programmer l'envoi des notifications de suivi au 06XX XX XX XX. Vous recevrez un SMS dès que le livreur sera en route. Une signature sera nécessaire à la réception."
      ]
    },
    {
      keyword: "problème",
      ...
      botResponses: [
        "Je suis désolé d'apprendre que vous rencontrez un problème avec votre compte. Pouvez-vous me préciser quel type de difficulté vous rencontrez (connexion, paramètres, permissions) ?",
        "Je comprends. Le problème de connexion que vous décrivez peut avoir plusieurs causes. Avez-vous essayé de réinitialiser votre mot de passe via le lien 'Mot de passe oublié' ? Si oui, vérifiez également vos dossiers de spam pour l'email de réinitialisation.",
        "Parfait. Je viens de vous envoyer un nouveau lien de réinitialisation à l'adresse john.doe@example.com. Ce lien expire dans 30 minutes. Si le problème persiste, je peux transférer votre demande à notre équipe technique qui pourra débloquer votre compte manuellement."
      ]
    },
    {
      keyword: "merci",
      ...
      botResponses: [
        "Je vous en prie ! C'est toujours un plaisir de pouvoir vous aider. N'hésitez pas à revenir vers moi si vous avez d'autres questions. Je vous souhaite une excellente journée !"
      ]
    },
    {
      keyword: "bonjour",
      ...
      botResponses: [
        "Bonjour ! Je suis ravi de vous accueillir sur Celsai. Je peux vous aider avec les remboursements, la facturation, le suivi de livraison ou tout problème technique. Comment puis-je vous assister aujourd'hui ?"
      ]
    }
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    for (const scenario of chatScenarios) {
      if (lowerInput.includes(scenario.keyword)) {
        foundScenario = { ...scenario, currentStep: 0 };
        break;
      }
    }
      ...
      <Container>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 bg-celsai-50 rounded-lg p-5 border border-celsai-100">
            <h4 className="font-medium mb-2 text-celsai-800">Scenarios d'interaction :</h4>
